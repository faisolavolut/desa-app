...
class UmkmProductCatalog extends Model implements HasMedia
{
    use HasFactory, HasImageUrl, InteractsWithMedia;
    protected $table = 'umkm_product_catalogs';
    ...
    protected static function booted()
    {
        ...
        static::saved(function ($catalog) {
            $catalog->updateQuietly([
                'file_path' => $catalog->getFirstMediaUrl('file_path') ? removeStoragePrefix($catalog->getFirstMediaUrl('file_path')) : null,
            ]);
        });
